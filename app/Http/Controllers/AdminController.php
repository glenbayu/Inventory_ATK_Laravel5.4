...
class AdminController extends Controller
{
    public function index()
    {
        ...
        // Departemen diambil dari data transaksi (input saat user mengajukan request),
        // bukan dari profil departemen user.
        $deptStats = DB::table('transactions')
            ->select('transactions.department as department', DB::raw('count(*) as total'))
            ->whereNotNull('transactions.department')
            ->where('transactions.department', '!=', '')

                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        <button type="button" class="btn btn-sm btn-success btn-xs btn-industrial"
                                            data-toggle="modal" data-target="#modalRestock{{ $item->id }}">
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            ...
                                            <button type="button" class="btn btn-danger btn-xs btn-industrial"
                                                onclick="showDeleteModal('delete-form-{{ $item->id }}', '{{ $item->name }}')">
                ...
                <form action="{{ route('admin.items.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Contoh: Pulpen Standard"
                                required>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content"
                ...
                <div class="modal-footer" style="background: #222; border-top: 2px solid #c0392b;">
                    ...
                    <button type="button" class="btn btn-danger btn-industrial" id="btnExecuteDelete"
                        style="background: #c0392b; border-color: #000;">
                        YA, MUSNAHKAN
                    </button>
                </div>
                    ...
                    <form action="{{ route('admin.item.restock', $item->id) }}" method="POST">
                        ...
                        <div class="modal-footer" style="background: #222; border-top: 2px solid #27ae60;">
                            ...
                            <button type="submit" class="btn btn-success btn-industrial"
                                style="background: #27ae60; color: #fff; border-color: #219150;">
                                SIMPAN STOK
                            </button>
                        </div>
                    </form>

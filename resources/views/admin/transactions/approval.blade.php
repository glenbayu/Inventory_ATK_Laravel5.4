                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;">
                                ...
                                <small class="text-muted">{{ $firstItem->department ?: $firstItem->user->department }}</small>
                            </td>
                            <td style="vertical-align: middle;">
        ...
        <div class="modal-content" style="border-radius: 0; border: 3px solid #333;">
            ...
            <div class="modal-header" style="background: #222; color: #fff;">
                ...
                <h4 class="modal-title" style="font-family: 'Roboto Mono'">
                    DETAIL: {{ $code }} <br>
                    <small style="color: #ccc;">User: {{ $firstItem->user->name }} ({{ $firstItem->department ?: $firstItem->user->department }})</small>
                </h4>
            </div>

            ...
            <div class="panel-body">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        @php
                            $waktuKeluar = $trx->updated_at->copy()->timezone('Asia/Jakarta');
                        @endphp
                        <tr>
                            <td style="font-family:'Roboto Mono'">
                                {{ $waktuKeluar->format('d M Y') }} <br>
                                <small class="text-muted">{{ $waktuKeluar->format('H:i') }} WIB</small>
                            </td>
                            ...
                            <td>
                                ...
                                <span class="label label-default">{{ $trx->department ?: $trx->user->department }}</span>
                            </td>
